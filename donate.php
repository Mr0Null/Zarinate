...
<body>
    ...
    <img class="media-object img-circle center-block" data-src="holder.js/100x100" alt="MohammadAmin Vahedinia" src="https://avatars1.githubusercontent.com/u/16556650?v=3&amp;s=460" itemprop="image">
    </div>
    <div class="contact-details">
    <div class="name-and-profession">
    <h3 class="text-bolder name" itemprop="name">Donate to MohammadAmin Vahedinia</h3>
    </div>
    <div class="detail">
        <span class="icon">
        ...
        <span class="info">
        <a href="mailto:mohammadamin@vahedinia.me" class="link-disguise" itemprop="email">mohammadamin@vahedinia.me</a>
        </span>
    </div>
    <div class="detail">
        <span class="icon">
        ...
        <span class="info">
        <a href="https://hexlinux.ir" class="link-disguise">Blog</a>
        </span>
    </div>
    </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2 col-sm-12">
            <form action="/payment.php" method="post" id="donationForm">
                <div class="input-group">
                  <span class="input-group-addon" id="amountAddon"><i class="fa fa-money" aria-hidden="true"></i></span>
                  <input type="text" class="form-control" placeholder="amount (in toman, at least 1000T)" aria-describedby="amountAddon" name="amount">
                </div>
                <br>
                <div class="input-group">
                  <span class="input-group-addon" id="usernameAddon"><i class="fa fa-id-card-o" aria-hidden="true"></i></span>
                  <input type="text" class="form-control" placeholder="your name" aria-describedby="usernameAddon" name="username">
                </div>
                <br>
                <div class="input-group">
                  <span class="input-group-addon" id="useremailAddon"><i class="fa fa-envelope-o" aria-hidden="true"></i></span>
                  <input type="text" class="form-control" placeholder="your email (better to be your gravatar mail)" aria-describedby="useremailAddon" name="useremail">
                </div>
                <br>
                <button type="submit" class="btn btn-lg btn-success col-xs-12">Make a donation!</button>
            </form>
        </div>
    </div>
    </div>
